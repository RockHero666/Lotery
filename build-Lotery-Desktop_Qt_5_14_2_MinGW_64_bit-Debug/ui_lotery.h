...
public:
    ...
    void setupUi(QMainWindow *Lotery)
    {
        ...
        Lotery->setMaximumSize(QSize(1280, 750));
...
""));
        ...
        logo->setGeometry(QRect(770, 280, 400, 60));
...
""));
        ...
        win_btn_logo->setGeometry(QRect(1111, 1111, 1300, 750));
        win_btn_logo->setMinimumSize(QSize(1300, 750));
...
""));
        ...
        jack->setGeometry(QRect(355, -70, 571, 341));
        jack->setScaledContents(true);
        money = new QLabel(centralWidget);
        money->setObjectName(QString::fromUtf8("money"));
        money->setGeometry(QRect(50, 10, 261, 90));
        money->setScaledContents(true);
        exit = new QLabel(centralWidget);
        exit->setObjectName(QString::fromUtf8("exit"));
        exit->setGeometry(QRect(50, 105, 261, 75));
        exit->setScaledContents(true);
        how_money = new QLabel(centralWidget);
        how_money->setObjectName(QString::fromUtf8("how_money"));
        how_money->setGeometry(QRect(100, 30, 141, 41));
